...
class _TrailBrakeState:
    """Internal state for the trail brake training tab."""
...
class TrailBrakeTab(QWidget):
    """Trail Brake training tab.
    ...
    def __init__(self, *, read_brake_percent: Callable[[], float]) -> None:
        """Initialize the trail brake tab.
    ...
    def _create_chart(self):
        ...
        chart.setTitle("Trail Brake Training")
    ...
    def _save_selection(self) -> None:
        ...
        save_trail_brake_config(TrailBrakeConfig(selected_trace=name))
